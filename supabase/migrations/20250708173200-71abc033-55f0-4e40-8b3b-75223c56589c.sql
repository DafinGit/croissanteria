...
ADD COLUMN total_points_earned bigint DEFAULT 0;
...
-- Create or replace function to update total earned points
...
-- Update loyalty level calculation to use total earned points instead of current points
